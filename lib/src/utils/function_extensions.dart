...
extension Fn0X<R> on R Function()? {
...
extension Fn1X<R, T1> on R Function(T1)? {
...
extension Fn2X<R, T1, T2> on R Function(T1, T2)? {
...
extension Fn3X<R, T1, T2, T3> on R Function(T1, T2, T3)? {
...
extension Fn4X<R, T1, T2, T3, T4> on R Function(T1, T2, T3, T4)? {
...
extension Fn5X<R, T1, T2, T3, T4, T5> on R Function(T1, T2, T3, T4, T5)? {
